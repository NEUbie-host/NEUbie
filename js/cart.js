...
document.getElementById("checkout-btn").addEventListener("click", function () {
    ...
    // Ví dụ: xử lý đơn giản để hiển thị thông báo
    if (!paymentMethod) {
        alert("Please select a payment method.");
        return;
    }

    // Giả lập gửi thanh toán (có thể gọi API thực ở đây)
    alert("You selected: " + paymentMethod.toUpperCase());

    // Hiển thị lời cảm ơn và ẩn giỏ hàng
    document.querySelector(".col.cart").style.display = "none";
    document.querySelector(".col.thanks").style.display = "block";
